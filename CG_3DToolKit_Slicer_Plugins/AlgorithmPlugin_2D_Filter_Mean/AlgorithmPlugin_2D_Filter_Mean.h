#ifndef ALGORITHMPLUGIN_2D_Filter_Mean_H
#define ALGORITHMPLUGIN_2D_Filter_Mean_H

#include <QtPlugin>
#include <AlgorithmInterface.h>
#include <AlgorithmFuction.h>

class AlgorithmPlugin_2D_Filter_Mean : public AlgorithmInterface
{
    Q_OBJECT
    Q_PLUGIN_METADATA(IID "AlgorithmPlugin_2D_Filter_Mean")
    Q_INTERFACES(AlgorithmInterface)

public:
    explicit AlgorithmPlugin_2D_Filter_Mean(AlgorithmInterface *parent = nullptr);
    ~AlgorithmPlugin_2D_Filter_Mean() = default;
...
#endif // ALGORITHMPLUGIN_2D_Filter_Mean_H
